...
import type { SpellbookEntry, SpellReferenceData } from "../SpellBookView";
...
export const CantripCollapsed: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Level-0 spells show "C" in the level indicator instead of a Roman numeral.',
      },
    },
  },
};
...
export const UnpreparedSpell: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A spell that is known but not currently prepared — no bookmark shown.",
      },
    },
  },
};
...
export const ExpandedExpensiveMaterial: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByText(/diamond dust worth 25 gp/i)).toBeInTheDocument();
  },
  parameters: {
    docs: {
      description: {
        story: "Material components with long descriptive text (including cost) render fully.",
      },
    },
  },
};
...
export const ExpandedVSMOnly: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByText(/petrified eye of a newt/i)).toBeInTheDocument();
    await expect(canvas.getByText(/At Higher Levels/i)).toBeInTheDocument();
  },
};
...
export const ExpandedVSNoMaterial: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "When material is null the component label shows only V, S with no parenthetical.",
      },
    },
  },
};
...
export const CollapseAfterExpand: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Clicking the header a second time collapses the expanded details.",
      },
    },
  },
};
...
export const HighLevelSpell: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Level 4 spell renders the Roman numeral IV in the level indicator.",
      },
    },
  },
};
