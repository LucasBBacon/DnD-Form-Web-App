...
describe("TraitAccordion", () => {
  ...
  it("shows short descriptions when collapsed", () => {
    ...
    expect(
      screen.getByText("See in dim light within 60 feet."),
    ).toBeInTheDocument();
  });

  it("shows full description for the expanded trait", () => {
    render(
      <TraitAccordion traits={traits} expandedIndex={0} onToggle={() => {}} />,
    );
    expect(
      screen.getByText("Full darkvision description."),
    ).toBeInTheDocument();
  });
  ...
  it("hides short description for the expanded trait", () => {
    ...
    expect(
      screen.queryByText("See in dim light within 60 feet."),
