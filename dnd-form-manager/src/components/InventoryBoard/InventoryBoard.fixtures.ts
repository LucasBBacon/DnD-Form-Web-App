import { ENCUMBRANCE_FIXTURES, INVENTORY_FIXTURES } from "../../fixtures/boardFixtures";
import type {
...
export const INVENTORY_BOARD_FIXTURES: Record<string, InventoryBoardScenario> = {
  ...
  standardLoadout: {
    ...
    stacks: [
      ...
      toStack(INVENTORY_FIXTURES.adventuringKit.stacks[1], "Burns for 1 hour"),
    ],
    equippedWeaponInstanceIds: INVENTORY_FIXTURES.adventuringKit.equippedWeaponInstanceIds,
    equippedArmorInstanceId: INVENTORY_FIXTURES.adventuringKit.equippedArmorInstanceId,
    equippedShieldInstanceId: INVENTORY_FIXTURES.adventuringKit.equippedShieldInstanceId,
  ...
  fullyAttuned: {
    ...
    equippedArmorInstanceId: null,
    equippedShieldInstanceId: null,
    attunedInstanceIds: INVENTORY_FIXTURES.attunedMagicLoadout.attunedInstanceIds,
  },
  encumbered: {
    encumbrance: {
    ...
    equippedWeaponInstanceIds: [],
    equippedArmorInstanceId: INVENTORY_FIXTURES.adventuringKit.instances[1].instanceId,
    equippedShieldInstanceId: null,
    attunedInstanceIds: [],
  },
  missingReferences: {
  ...
  playground: {
    ...
    equippedWeaponInstanceIds: [INVENTORY_FIXTURES.adventuringKit.instances[0].instanceId],
    equippedArmorInstanceId: null,
    equippedShieldInstanceId: INVENTORY_FIXTURES.adventuringKit.instances[2].instanceId,
    attunedInstanceIds: [INVENTORY_FIXTURES.attunedMagicLoadout.instances[0].instanceId],
  },
};
